...
void loop()
{
    ...
    // Lee los datos del fotoresistor [V]
    ...
    // JSON para iluminancia
    json = "{\"value\": " + String(voltage) + "}";
    ...
    if (!isnan(h) && !isnan(t) && !isnan(voltage))
    {
